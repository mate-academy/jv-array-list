...
public class ArrayListTest {
    ...
    public void removeElementFromArrayListByValue() {
        ...
        String actualResult = arrayList.remove("Java").toString();
    ...
    public void removeObjectValueByValue() {
        ...
        Object actualResult = cats.remove(fourthCat);
